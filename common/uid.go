...
// UID is a method to generate a virtual unique identifier for the whole system
...
func (uid UID) String() string {
	val := uint64(uid.localId)<<28 | uint64(uid.objectType)<<18 | uint64(uid.shardId)<<0 // bitwise
